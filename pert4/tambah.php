...
function auto($terpakai, $jumlah){
  return $terpakai + $jumlah;
}
...
$insert = mysqli_query($conn,"INSERT INTO data_barang VALUES (
                              '', '$nama', '$jenis', '$harga', '$terpakai', '$cadangan', '$jumlah')");
...
<body>
  ...
  <!-- Form Tambah Data-->
        ...
        <form class="pl-4 pt-2" action="" method="post">
            ...
            <br>
            <br>
            <button class="btn btn-large btn-primary" type="submit" name="tambah">Tambah</button>
            </form>
